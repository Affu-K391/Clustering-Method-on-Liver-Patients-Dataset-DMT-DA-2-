...
", header = TRUE)
clustering_data2 <- data2[, c("Total_Bilirubin", "Direct_Bilirubin", "Total_Protiens", "Albumin")]
dbscan_result2 <- dbscan(clustering_data2, eps = 50000, minPts = 3)
print(dbscan_result2$cluster)
plot(clustering_data2, col = dbscan_result2$cluster + 1, pch = 19, main = "DBSCAN Clustering")
cat("Noise Points:", sum(dbscan_result2$cluster == 0), "\n")
